    ...
    <div className="items-center">
      ...
      <form action="" className="flex items-center">
        <div className="items-center  ml-20">
          <img className="w-48 h-56" src="src/assets/7938113 (1).jpg" alt="" />
          <h4 className="text-black-200  ml-20">
            LEADING BEST <br />
            CLOTHING <br />
      ...
      <div className="text-center text-black-200">
      ...
      <div className="flex text-gray-600 p-3 text-center">
        <h4 className="p-3">Website terms</h4>

        <h4 className="p-3">Privacy Policy</h4>
      </div>
      <span className="text-sm  text-gray-500 sm:text-center p-4 dark:text-gray-400">@ 2023 <a href="https://flowbite.com/" className="hover:underline">Samori</a>. All Rights Reserved.
    </span>
    </div>
  );
}
