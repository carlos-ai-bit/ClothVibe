        ...
        <form action="">
          <div className="shadow mx-8 mb-4 py-4 items-center flex flex-wrap ml-64">
            ...
            <div className="shadow mx-8 mb-4 py-4 w-56 rounded-lg ">
              ...
              <img src="src/Assets/Sweater.jpg" alt="Sweater" />
              <div className="icon-container flex items-center ml-10">
                <FontAwesomeIcon icon={faDollarSign} className="Dollar-icon" />
                <h1 className='ml-2 mr-4'>500.00</h1>
                <FontAwesomeIcon icon={faShoppingCart} className="Cart-icon" />
            ...
            <div className="shadow mx-8 mb-4 py-4 w-56 rounded-lg ">
              ...
              <img src="src/Assets/Sweater2.jpg" alt="Sweater" />
              <div className="icon-container flex items-center ml-10">
                <FontAwesomeIcon icon={faDollarSign} className="Dollar-icon" />
                <h1 className='ml-2 mr-4'>500.00</h1>
                <FontAwesomeIcon icon={faShoppingCart} className="Cart-icon" />
            ...
            <div className="shadow mx-8 mb-4 py-4 w-56 rounded-lg ">
              ...
              <img src="src/Assets/images (2).jpeg" alt="Sweater" />
              <div className="icon-container flex items-center ml-10">
                <FontAwesomeIcon icon={faDollarSign} className="Dollar-icon" />
                <h1 className='ml-2 mr-4'>500.00</h1>
                <FontAwesomeIcon icon={faShoppingCart} className="Cart-icon" />
