...
<form className="space-y-6" action="#" method="POST">
  ...
  <div>
     <div className="mt-2">
          <input id="email" name="email" type="email" placeholder="Password*" required className="block w-full px-2 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-blue-500 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6" />
                  </div>
                      </div>
